#ifndef _INC_T39FX_INCLUDES_H_
#define _INC_T39FX_INCLUDES_H_
...
/*********************************************************************************/
/* Operating Chip set : T39FX                                                  */
/* Software version   : version 1.01                                             */
/* Software Update    : 2011.01.13                                              */
/*********************************************************************************/
#define INC_FW_VERSION		"T39FX_v1.01"
...
#define T39FX_SCAN_IF_DELAY				1500
#define T39FX_SCAN_RF_DELAY				1500
#define T39FX_PLAY_IF_DELAY				1000
#define T39FX_PLAY_RF_DELAY				1100

#define INC_T39FX_CHIP					0x39F0
#define INC_T39FX_CHIP_ID				0xC00
...
/* Change for using one Soure File ucChip : 0 (T39F0), ucChip : 1(T39F1)*/
INC_UINT8 INC_RF500_START(INC_UINT8 ucI2CID, INC_UINT32 ulRFChannel, ENSEMBLE_BAND ucBand, INC_UINT16 ucChip);
