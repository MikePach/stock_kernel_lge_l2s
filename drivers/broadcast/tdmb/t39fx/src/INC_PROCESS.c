...
void INC_SCAN_SETTING(INC_UINT8 ucI2CID)
{
	...
	INC_CMD_WRITE(ucI2CID, APB_RF_BASE+0xB6, T39FX_SCAN_IF_DELAY&0xff);
	INC_CMD_WRITE(ucI2CID, APB_RF_BASE+0xB5, (T39FX_SCAN_IF_DELAY>>8)&0xff);
	INC_CMD_WRITE(ucI2CID, APB_RF_BASE+0xB4, (T39FX_SCAN_IF_DELAY>>16)&0xff);

	INC_CMD_WRITE(ucI2CID, APB_RF_BASE+0xB3, T39FX_SCAN_RF_DELAY&0xff);
	INC_CMD_WRITE(ucI2CID, APB_RF_BASE+0xB2, (T39FX_SCAN_RF_DELAY>>8)&0xff);
	INC_CMD_WRITE(ucI2CID, APB_RF_BASE+0xB1, (T39FX_SCAN_RF_DELAY>>16)&0xff);
}
...
void INC_AIRPLAY_SETTING(INC_UINT8 ucI2CID)
{
	...
	INC_CMD_WRITE(ucI2CID, APB_RF_BASE+0xB6, T39FX_PLAY_IF_DELAY&0xff);
	INC_CMD_WRITE(ucI2CID, APB_RF_BASE+0xB5, (T39FX_PLAY_IF_DELAY>>8)&0xff);
	INC_CMD_WRITE(ucI2CID, APB_RF_BASE+0xB4, (T39FX_PLAY_IF_DELAY>>16)&0xff);

	INC_CMD_WRITE(ucI2CID, APB_RF_BASE+0xB3, T39FX_PLAY_RF_DELAY&0xff);
	INC_CMD_WRITE(ucI2CID, APB_RF_BASE+0xB2, (T39FX_PLAY_RF_DELAY>>8)&0xff);
	INC_CMD_WRITE(ucI2CID, APB_RF_BASE+0xB1, (T39FX_PLAY_RF_DELAY>>16)&0xff);
}
...
#if 0
	INC_MSG_PRINTF(1, "================= T39FX INC_CHANNEL_START =================\r\n");
...
INC_UINT8 INC_ENSEMBLE_SCAN(INC_UINT8 ucI2CID, INC_UINT32 ulFreq)
{
	...
	//printk("[TDMB_T39FX] INC_ENSEMBLE_SCAN (%d)\n", ulFreq);
...
#if 0 /* ant-level calculation is done at tdmb_tunerbb_drv_t39xx.c */
