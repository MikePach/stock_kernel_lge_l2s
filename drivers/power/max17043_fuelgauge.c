...
/* START : dukyong.kim@lge.com 2012-03-17 Display All SOC 0 ~ 100% */
	...
	|| defined(CONFIG_MACH_MSM8960_D1LKT) || defined(CONFIG_MACH_MSM8960_L_DCM) ||defined(CONFIG_MACH_MSM8960_L1U) || defined(CONFIG_MACH_MSM8960_L1SK) || defined(CONFIG_MACH_MSM8960_L1KT)
			 ...
			 char *buf)
{
	...
	if(lge_power_test_flag == 1){
		...
		if(level != 0){
#if defined(CONFIG_MACH_MSM8960_D1LU) || defined(CONFIG_MACH_MSM8960_D1LSK) \
	|| defined(CONFIG_MACH_MSM8960_D1LKT) ||  defined(CONFIG_MACH_MSM8960_L1U) || defined(CONFIG_MACH_MSM8960_L1SK) || defined(CONFIG_MACH_MSM8960_L1KT)
			if(level >= 99)
...
#if defined(CONFIG_MACH_MSM8960_D1LV) || defined(CONFIG_MACH_MSM8960_D1LU) \
			|| defined(CONFIG_MACH_MSM8960_D1LSK) || defined(CONFIG_MACH_MSM8960_D1LKT) || defined(CONFIG_MACH_MSM8960_L1U) || defined(CONFIG_MACH_MSM8960_L1SK) || defined(CONFIG_MACH_MSM8960_L1KT) 
...
#if defined(CONFIG_MACH_MSM8960_D1LV) || defined(CONFIG_MACH_MSM8960_D1LU) \
		|| defined(CONFIG_MACH_MSM8960_D1LSK) || defined(CONFIG_MACH_MSM8960_D1LKT)
