...
#if defined(CONFIG_LGE_PM) && !defined(CONFIG_BATTERY_MAXIM14073)
...
#if defined(CONFIG_MACH_MSM8960_D1LU) || defined(CONFIG_MACH_MSM8960_D1LSK) || defined(CONFIG_MACH_MSM8960_D1LKT) || defined(CONFIG_MACH_MSM8960_L_DCM) || defined(CONFIG_MACH_MSM8960_L0) || defined(CONFIG_MACH_MSM8960_L2S)
...
static void adjust_vdd_max_for_fastchg(struct pm8921_chg_chip *chip)
{
	...
	pm8921_bms_get_simultaneous_battery_voltage_and_current(&ichg_meas_ua,&vbat_uv);
...
#if defined(CONFIG_MACH_MSM8960_D1LU) || defined(CONFIG_MACH_MSM8960_D1LSK) || defined(CONFIG_MACH_MSM8960_D1LKT)|| defined(CONFIG_MACH_MSM8960_L1U) || defined(CONFIG_MACH_MSM8960_L1SK) || defined(CONFIG_MACH_MSM8960_L1KT)
...
*/
	...
	chip->rconn_mohm = 0;//pdata->rconn_mohm;
