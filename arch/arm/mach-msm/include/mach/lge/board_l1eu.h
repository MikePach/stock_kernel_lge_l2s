...
/* LGE Specific */
#ifndef _BOARD_L1EU_H_
#define _BOARD_L1EU_H_
...
#define	PM8921_KB_LED_MAX_CURRENT	20	/* I = 10mA */
...
#define USB_SERIAL_NUMBER						"LGE_ANDROID_L1EU_DEV"
#define TS_X_MIN								0
#define TS_X_MAX							540
#define TS_Y_MIN								0
#define TS_Y_MAX							960
#define LCD_RESOLUTION_X						540
...
#define TOUCH_FW_VERSION			3	/* default Rev.B */
 ...
 */
/* L1EU, for USB ID detection
* Ref resistance value = L1EU(200K)
*  2012-02-21, chulho.park@lge.com
*/
#define ADC_CHANGE_REV	HW_REV_EVB1
/* L1EU, for L1EU Base version
* Fix PM error
*  2012-02-25, chulho.park@lge.com
*/
