...
/* LGE Specific */
#ifndef _BOARD_L1T_H_
#define _BOARD_L1T_H_
...
#define USB_SERIAL_NUMBER						"LGE_ANDROID_L1T_DEV"
#define TS_X_MIN								0
#define TS_X_MAX							540
#define TS_Y_MIN								0
#define TS_Y_MAX							960
 ...
 */
/* L1T, for USB ID detection
* Ref resistance value = L1T(200K)
*  2012-02-21, chulho.park@lge.com
*/
#define ADC_CHANGE_REV	HW_REV_EVB1
/* L1T, for L1T Base version
* Fix PM error
