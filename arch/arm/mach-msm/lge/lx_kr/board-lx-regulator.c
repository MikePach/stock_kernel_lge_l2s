...
VREG_CONSUMERS(L2) = {
	...
	REGULATOR_SUPPLY("mipi_csi_vdd",	"4-000d"), /* GSBI4, Slave Addr: 0x0d, imx111 */
	REGULATOR_SUPPLY("mipi_csi_vdd",	"4-006e"), /* GSBI4, Slave Addr: 0x6e, imx119 */
#else
...
msm_rpm_regulator_init_data[] __devinitdata = {
	...
	/* START:  pk.jeon@lge.com 2012-02-28 Improvement Peak Phase Error, S8 Max Voltage: 2.1->2.23 */
	//RPM_SMPS(S8,	 1, 1, 1, 2100000, 2100000, NULL, 100000, 1p60),
	RPM_SMPS(S8,	 1, 1, 1, 2100000, 2230000, NULL, 100000, 1p60),
	/* END: pk.jeon@lge.com 2012-02-28 */
	...
	/* START:  minwoo82.kim@lge.com 2012-02-21 Lx_kr touch-ic power enable */
	/*RPM_LDO(L17,	 0, 1, 0, 1800000, 2950000, NULL,      0, 0), */
	RPM_LDO(L17,	 0, 1, 0, 3000000, 3000000, NULL,      0, 0),
	/* END: minwoo82.kim@lge.com 2012-02-21 Lx_kr touch-ic power enable */
#ifdef CONFIG_SII8334_MHL_TX
	/*LGE_CHANGE
