...
#define MSM_ION_MM_SIZE		0x7400000 /*(116MB) for Lx_kr */// Original MSM_PMEM_ADSP_SIZE /* (120MB) */ /* LGE_CHANGE, Camera Zero shutter lag patch, 2012.01.12 jungryoul.choi@lge.com */
...
static struct ion_cp_heap_pdata cp_mm_ion_pdata = {
	...
	.align = PAGE_SIZE,
	.reusable = 0, /* FMEM_ENABLED, - temporary removed due to live effect video issue */
...
#ifdef CONFIG_LGE_BROADCAST_TDMB_T3900
	.max_clock_speed = 5400000,
#endif
#ifdef CONFIG_LGE_BROADCAST_TDMB_FC8050
	.max_clock_speed = 24000000,
#endif
/* START:  heri.jang@lge.com 2012-02-27 TDMB function is provided for lx_kr */
#ifdef CONFIG_LGE_BROADCAST_TDMB_T39FX
	.max_clock_speed = 5400000,
#endif
/* END:  heri.jang@lge.com 2012-02-27 TDMB function is provided for lx_kr */
};
#endif //CONFIG_LGE_BROADCAST_TDMB
/* 
 * QCT Original
 *
 * Moves to board-{model}-usb.c
 *
 */
#if !defined(CONFIG_MACH_LGE)
#ifdef CONFIG_USB_MSM_OTG_72K
...
static struct msm_spm_platform_data msm_spm_data[] __initdata = {
	[0] = {
		...
		.reg_init_values[MSM_SPM_REG_SAW2_PMIC_DLY] = 0x07070707,
...
static struct msm_rpmrs_level msm_rpmrs_levels[] = {
...

	{
		...
		false,
		12000, 51, 1130300, 9000,
	},
	{
		MSM_PM_SLEEP_MODE_POWER_COLLAPSE,
		MSM_RPMRS_LIMITS(ON, HSFS_OPEN, ACTIVE, RET_HIGH),
		false,
		13000, 51, 1130300, 10000,
	},
...
MACHINE_START(MSM8960_LX_KR, "LGE MSM8960 LX KR")
