...
#endif
/* START:  heri.jang@lge.com 2012-02-28 Lx model doesn't support Antenna selection */
/*#ifdef CONFIG_LGE_BROADCAST_TDMB */
/* */ /* add by heri.jang@lge.com for TDMB ANT selection*/
/*    PM8XXX_GPIO_OUTPUT(16, 0),                   */ /* DMB_ANT_SEL_EAR */
/*    PM8XXX_GPIO_OUTPUT(17, 0),                   */ /* DMB_ANT_SEL_INN */
/*#endif */
/* END:  heri.jang@lge.com 2012-02-28 Lx model doesn't support Antenna selection */
};
...
static struct i2c_registry lx_i2c_pm_subsystem __initdata = {
...
static void __init lge_add_i2c_pm_subsystem_devices(void)
{
	 ...
	 * Work-around code to support old H/W revision.
	 */
#ifdef CONFIG_MACH_MSM8960_LX_KR
	if (lge_get_board_revno() == HW_REV_A)
		pm8921_led_configs[1].id = PM8XXX_ID_LED_2;
#endif
	/* Run the array and install devices as appropriate */
	i2c_register_board_info(lx_i2c_pm_subsystem.bus,
				lx_i2c_pm_subsystem.info,
				lx_i2c_pm_subsystem.len);
}
...
void __init lge_add_pm_devices(void)
{
	...
	;
#endif
#if defined(CONFIG_MACH_MSM8960_L1U) || defined(CONFIG_MACH_MSM8960_L1SK) || defined(CONFIG_MACH_MSM8960_L1KT)		/* lx_kr revision */
