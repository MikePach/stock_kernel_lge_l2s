...
int amp_enable(int on_state)
{
	...
	if (init_status == 0) {
#if defined(CONFIG_MACH_MSM8960_D1LSK) || defined(CONFIG_MACH_MSM8960_D1LKT) || defined(CONFIG_MACH_MSM8960_D1LU) || defined(CONFIG_MACH_MSM8960_L1U) || defined(CONFIG_MACH_MSM8960_L1SK) || defined(CONFIG_MACH_MSM8960_L1KT)
	...
	case 2:
		...
		/* i2c fail debugging, rev B uses vpwr. */
		return 0;
...
static struct i2c_registry lx_i2c_audiosubsystem __initdata = {
...
{
	i2c_register_board_info(lx_i2c_audiosubsystem.bus,
				lx_i2c_audiosubsystem.info,
				lx_i2c_audiosubsystem.len);
}
#endif
