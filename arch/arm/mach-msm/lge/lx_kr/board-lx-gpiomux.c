...
static struct gpiomux_setting slimbus = {
	...
	/* LGE_CHANGE
	* 2011-10-31, bob.cho@lge.com
	* fixed SLIMBus MCLK overshoot
	* driver strength : 8mA -> 4mA
	*/
	.drv = GPIOMUX_DRV_4MA,
#else
	.drv = GPIOMUX_DRV_8MA,
...
/* For camera flash, enables gsbi8, sunkyoo.hwang@lge.com, 10/06/2011 */
...
#ifdef CONFIG_LGE_BROADCAST_TDMB
	{
		.gpio	   = 71, 	/* GSBI10 QUP SPI_DATA_MOSI */
		.settings = {
	...
	{
		.gpio	   = 72, 	/* GSBI10 QUP SPI_DATA_MISO */
		.settings = {
			[GPIOMUX_ACTIVE] = &gsbi10_spi_active,
			[GPIOMUX_SUSPENDED] = &gsbi10_spi_suspended_config,
		},
