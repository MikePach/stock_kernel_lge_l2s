...
/* LGE_CHANGE_S VT Camera Mclk driving current change: 2mA -> 6mA for L2S only, 2012-03-29, tao.jin@lge.com */
#if defined(CONFIG_MACH_MSM8960_L2S)
	{
		.func = GPIOMUX_FUNC_2, /*active 8*/
		.drv = GPIOMUX_DRV_4MA,/*GPIOMUX_DRV_6MA** LGE_CHANGE_S VT Camera Mclk driving current change: 6mA -> 4mA for L2S FCC test, 2012-06-13, tao.jin@lge.com */
		.pull = GPIOMUX_PULL_UP,
	},
#endif
/* LGE_CHANGE_E VT Camera Mclk driving current change: 2mA -> 6mA for L2S only, 2012-03-29, tao.jin@lge.com */
	{
...
static struct msm_gpiomux_config msm8960_cam_common_configs[] = {
	...
	},
	{
		...
		.settings = {
/* LGE_CHANGE_S VT Camera Mclk driving current change: 2mA -> 6mA for L2S only, 2012-03-29, tao.jin@lge.com */
/* LGE_CHANGE_S VT Camera Mclk driving current change: 4mA -> 2mA for L2S FCC:EMI Test, 2012-08-13, tao.jin@lge.com */
#if 0
//#if defined(CONFIG_MACH_MSM8960_L2S)
/* LGE_CHANGE_E VT Camera Mclk driving current change: 4mA -> 2mA for L2S FCC:EMI Test, 2012-08-13, tao.jin@lge.com */
...
#elif defined(CONFIG_MACH_MSM8960_L1A) ||defined(CONFIG_MACH_MSM8960_L1T) ||defined(CONFIG_MACH_MSM8960_L1EU) 	// added L1T  20120320_sunwoo.lee
...
static struct camera_vreg_t msm_8960_back_cam_vreg[] = {
	...
	{"cam1_vana", REG_LDO, 2800000, 2850000, 80000},
	{"cam1_vio", REG_VS, 0, 0, 0},
/* LGE_CHANGE_S VCM voltage change: 2.8V -> 2.6V only for L2S current issue, 2012-05-04, tao.jin@lge.com */
#if defined(CONFIG_MACH_MSM8960_L2S)
	{"cam1_vaf", REG_LDO, 2600000, 2600000, 300000},
#else
	{"cam1_vaf", REG_LDO, 2800000, 2800000, 300000},
#endif
/* LGE_CHANGE_E VCM voltage change: 2.8V -> 2.6V only for L2S current issue, 2012-05-04, tao.jin@lge.com */
};
#endif
...
static struct i2c_board_info s5k4e1_actuator_i2c_info = {
	I2C_BOARD_INFO("s5k4e1_act", I2C_SLAVE_ADDR_S5K4E1_ACT), /* 0x18 */
};
...
#ifdef CONFIG_MT9V113
	{
	I2C_BOARD_INFO("mt9v113", I2C_SLAVE_ADDR_MT9V113), /* 0x7A */
