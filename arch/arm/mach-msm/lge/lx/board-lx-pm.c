...
/* BEGIN : jooyeong.lee@lge.com 2012-02-27 Change the charger_temp_scenario */
	...
	.temp_level_3		= 42,
	.temp_level_4		= -5,
	.temp_level_5		= -8,		//HW Request jeongyong.lee@lge.com
...
static struct pm8921_bms_platform_data pm8921_bms_pdata __devinitdata = {
	...
	.i_test			= 172,
#elif defined(CONFIG_MACH_MSM8960_L2S)
	.i_test			= 173,
#else /* QCT ORG */
	.i_test			= 2500,
#endif
...
#else
static struct led_info pm8921_led_info[] = {
#if defined (CONFIG_MACH_MSM8960_L1A)||defined(CONFIG_MACH_MSM8960_L1T) ||defined(CONFIG_MACH_MSM8960_L1EU)	// added L1T  20120320_sunwoo.lee
	[0] = {
		.name			= "button-backlight",
	},
#else
...
#if defined (CONFIG_MACH_MSM8960_D1LA)|| defined(CONFIG_MACH_MSM8960_L1A)||defined(CONFIG_MACH_MSM8960_L1T) ||defined(CONFIG_MACH_MSM8960_L1EU)	// added L1T  20120320_sunwoo.lee
...
{
	/* LGE_CHANGE
	 * 2012-06-11, sangyeol.ryu@lge.com
	 * Work-around code to support old H/W revision.
	 * use DC motor below Rev.C
	 * use Q-Coin motor over Rev.D
	 */
#if defined(CONFIG_MACH_MSM8960_L2S)
