...
VREG_CONSUMERS(L11) = {
	...
	REGULATOR_SUPPLY("cam1_vana",		"4-000d"),
	REGULATOR_SUPPLY("cam2_vana",		"4-006e"),
	REGULATOR_SUPPLY("cam1_vana",		"4-0020"),
	REGULATOR_SUPPLY("cam2_vana",		"4-007a"),
#else
...
VREG_CONSUMERS(L12) = {
	...
	REGULATOR_SUPPLY("cam1_vdig",		NULL),
	REGULATOR_SUPPLY("cam2_vdig",		NULL),
	...
	REGULATOR_SUPPLY("cam1_vdig",		NULL),
	REGULATOR_SUPPLY("cam2_vdig",	        "4-006e"),
	
#else
	REGULATOR_SUPPLY("cam1_vdig",	        "4-000d"),
	REGULATOR_SUPPLY("cam2_vdig",	        "4-006e"),
...
#ifdef CONFIG_MACH_LGE
	REGULATOR_SUPPLY("cam1_vaf",		"4-000d"),
	REGULATOR_SUPPLY("cam1_vaf",		"4-0020"),
#else
...
#ifdef CONFIG_MACH_LGE
	REGULATOR_SUPPLY("cam1_vio",		"4-000d"),
	REGULATOR_SUPPLY("cam2_vio",		"4-006e"),
	REGULATOR_SUPPLY("cam1_vio",		"4-0020"),
	REGULATOR_SUPPLY("cam2_vio",		"4-007a"),
#else
...
msm_rpm_regulator_init_data[] __devinitdata = {
    ...
    /* Changed by MSM8960AAAAANLYA1049A */
